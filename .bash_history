...
git push
git pull
git pull https://github.com/PB-PDX/django_project.git
git add -A
git comm
git pull
git pull https://github.com/PB-PDX/django_project.git
...
sudo service apache2 restart
git push
git push https://github.com/PB-PDX/django_project.git
git push https://github.com/PB-PDX/django_project.git
git status
sudo nano /etc/config.json
sudo nano django_project/settings.py
...
ls -la
exit
scp C:\Users\path/.ssh/id_rsa.pub user@IP address:~/.ssh/authorized_keys
exit
sudo service apache2 restart
exit
sudo nano /etc/ssh/sshd_config
...
ssh-rsa  rsa-key-20210911
